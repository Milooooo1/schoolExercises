...
from mcts_agent import random_dummy_player2, random_dummy_player3
import time
        ...
        for i in range(len(self.players)):
            for j in range(len(self.players)):
                ...
                while not over:
                    ...
                    print("Player 2 (o) played move: "+ str(move) if game[1] % 2 != 1 else "Player 1 (x) played move: "+ str(move))
                    # print("Player 2 (o) played move: "+ str(move) if game[1] % 2 != 1 else "")
...
game = gomoku.starting_state(19)
player = random_dummy_player2()   #Default MCTS
# player2 = random_dummy_player()   #Random player
player3 = random_dummy_player3()  #Heuristis MCTS
comp = competition(19)
...
# for i in range(0, 50):
#     # print("Playing match number: "+str(i+1))
#     comp.play_competition()
#     comp.print_scores()
