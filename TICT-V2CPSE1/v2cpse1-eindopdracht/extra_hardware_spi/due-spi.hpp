...
namespace due {
    ...
    class spi_bus_due : public hwlib::spi_bus {
        ...
        uint8_t write_byte(uint16_t data) {
    ...
    public:
         ...
         */
        void write_and_read(size_t n,
                            const uint8_t data_out[]
                            ) {
                write_byte(data_out[0]);
        }
        ...
        spi_bus_due() {
            ...
            // Set configuration.
            SPI0->SPI_MR = (0x1           // WDRBT enabled, PS Fixed, Master.
            ...
            //                     | 0x2);             // CPOL = 0, NCHPA = 1
            SPI0->SPI_CSR[0] = (0b00000000000000010000000100000011);
